...
export function WinTaskBar({ openSearch, openWinSearch, openWinArrow }: { openSearch: () => void, openWinSearch: () => void, openWinArrow: () => void }) {
  ...
  return (
    ...
    >
      <div onClick={() => openWinSearch()} className="flex flex-row h-10 items-center hover:bg-white/10 hover:rounded-md w-13 px-1 mr-3">
        <Image
          alt="Win"
      ...
      <WinTaskBarSystemOptions openWinArrow={openWinArrow}/>
    </div>
  );
}
